import { UserSlidesData } from '../../../../../../data/json/IndexHeroSlides.data.js';
import { getUserInfo } from '../../../../../controller/C_home.js';

const SlideData = UserSlidesData[0];
const {img, sTitle, title, titleSpan, desc, link} = SlideData;
const userInfo = await getUserInfo() || {lName: 'user'};
            ...
            `<div class="index_hero_s_slide">
                ...
                <div class="content_block index_hero_s_slide_container">
                    <div class="index_hero_s_slide_content">
                        <div class="index_hero_s_slide_small_title capitalise">Bun venit, ${userInfo.lName}!</div>
...
export const SlideUser1 = SlideContent;